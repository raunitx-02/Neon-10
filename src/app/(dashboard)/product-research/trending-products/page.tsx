...
const CATEGORIES = [
  ...
  { id: "1318081031", name: "Books", icon: "📚" },
  { id: "4772060031", name: "Car & Motorbike", icon: "🏍️" },
  { id: "1571271031", name: "Clothing & Accessories", icon: "👕" },
  ...
  { id: "4286640031", name: "Home Improvement", icon: "🔨" },
  { id: "5866078031", name: "Industrial & Scientific", icon: "🔬" },
  { id: "22143305031", name: "Jewellery", icon: "💎" },
  { id: "1571277031", name: "Kindle Store", icon: "📖" },
  { id: "976416031", name: "Movies & TV Shows", icon: "🎬" },
  { id: "4149520031", name: "Music", icon: "🎵" },
  { id: "3677697031", name: "Musical Instruments", icon: "🎸" },
  { id: "2454172031", name: "Office Products", icon: "📎" },
  { id: "85183752031", name: "Pet Supplies", icon: "🐾" },
  { id: "1571283031", name: "Shoes & Handbags", icon: "👠" },
  { id: "1318117031", name: "Software", icon: "💾" },
  { id: "1984443031", name: "Sports, Fitness & Outdoors", icon: "🏃" },
  { id: "1350380031", name: "Toys & Games", icon: "🧸" },
  { id: "13945368031", name: "Video Games", icon: "🎮" },
  { id: "21488213031", name: "Watches", icon: "⌚" },
];
